...
ggsave("Diabetes_Incidence.png", dpi = 1200, width = 8, height = 8, units = "in")
```
...
ggsave("corrplot.png", dpi = 1200, width = 8, height = 8, units = "in")
```
...
data %>% 
  ...
  theme(plot.background = element_rect(fill = '#f2f2f2', colour = '#f2f2f2')) +
  theme(panel.background = element_rect(fill = '#f2f2f2', colour = '#f2f2f2'))
ggsave("Diabetes_Incidence_by_Age.png", dpi = 1200, width = 8, height = 8, units = "in")
```
...
data %>% 
  ...
  theme(plot.background = element_rect(fill = '#f2f2f2', colour = '#f2f2f2')) +
  theme(panel.background = element_rect(fill = '#f2f2f2', colour = '#f2f2f2'))
ggsave("Diabetes_Incidence_by_Gender.png", dpi = 1200, width = 8, height = 8, units = "in")
```
...
data %>% 
  ...
  theme(plot.background = element_rect(fill = '#f2f2f2', colour = '#f2f2f2')) +
  theme(panel.background = element_rect(fill = '#f2f2f2', colour = '#f2f2f2'))
ggsave("Diabetes_Incidence_by_Polyuria.png", dpi = 1200, width = 8, height = 8, units = "in")
```
...
data %>% 
  ...
  theme(plot.background = element_rect(fill = '#f2f2f2', colour = '#f2f2f2')) +
  theme(panel.background = element_rect(fill = '#f2f2f2', colour = '#f2f2f2'))
ggsave("Diabetes_Incidence_by_Polydipsia.png", dpi = 1200, width = 8, height = 8, units = "in")
```
...
data %>% 
  ...
  theme(plot.background = element_rect(fill = '#f2f2f2', colour = '#f2f2f2')) +
  theme(panel.background = element_rect(fill = '#f2f2f2', colour = '#f2f2f2'))
ggsave("Diabetes_Incidence_by_Sudden_Weight_Loss.png", dpi = 1200, width = 8, height = 8, units = "in")
```
...
data %>% 
  ...
  theme(plot.background = element_rect(fill = '#f2f2f2', colour = '#f2f2f2')) +
  theme(panel.background = element_rect(fill = '#f2f2f2', colour = '#f2f2f2'))
ggsave("Diabetes_Incidence_by_Partial_Paresis.png", dpi = 1200, width = 8, height = 8, units = "in")
```
